                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<hr>
                                <div class="span3">
										<center>
										<img id="developers" src="admin/developers/Jonald R. Sevellejo.jpg" class="img-circle">
										<hr>
										<p>Name: Jonald Remus Sevellejo</p>
										<p>Address: Guiljungan,Cauayan</p>
										<p>Email: JonRemusSevellejo@yahoo.com</p>
                                ...
                                <div class="span3">
										<center>
								        <img id="developers" src="admin/developers/Jeffrey A. Daliva.jpg" class="img-circle">
								        <hr>
                                ...
                                <div class="span3">
										<center>
								        <img id="developers" src="admin/developers/Renaldo Tianzon.jpg" class="img-circle">
								        <hr>
