        ...
        <div class="container-fluid">
                ...
                <div class="span9" id="content">
					 ...
					 <a href="device_location.php" class="btn btn-info"  id="return" data-placement="right" title="Click to return" ><i class="icon-arrow-left icon-large"></i> Back</a>
		              ...
		              $('#return').tooltip('hide');
						...
						<?php $location_query = mysqli_query(dbcon(), "select * from stlocation	                     
            ...
            <div id="block_bg" class="block">
               ...
               <div id="" class="muted pull-right">
				<?php 
				$my_device = mysqli_query(dbcon(), "select * from location_details    
...
<?php
 ...
 <!-----------------------------------device categorized by their location details using nav pills------------------------------------>	
	<div class="pull-left">
			...
			<?php	
	          $my_keyboard = mysqli_query(dbcon(), "select * from location_details    
	          LEFT JOIN stdevice ON location_details.id = stdevice.id
			  LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			  where NOT EXISTS 
             (select * from location_details where dev_status='Dump')
             ...
             (select * from location_details where dev_status='Dump')
			  ...
			  ?>
				...
				<?php	
	            $my_mouse = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
			   ...
			   <?php	
	            $my_monitor = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
               ...
               ?>
				...
				<li class="">			
				 ...
				 <?php	
	            $my_cpu = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
              ...
              <?php	
	            $my_power_supply = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
               ...
               ?>			
				...
				<?php	
	            $my_vga = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
               ...
               ?>				
				...
				<?php	
	            $my_avr = mysqli_query(dbcon(), "select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
<tr>
		<td><?php
			   $device_query2 = mysqli_query(dbcon(), "select * from stdevice ")or die(mysqli_error());
			...
			<td><?php
			   $my_device1 = mysqli_query(dbcon(), "select * from stdevice ")or die(mysqli_error());
