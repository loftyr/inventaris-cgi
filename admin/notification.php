...
<form action="read.php" method="post">
					...
					<?php } ?>
					   ...
					   <?php $query = mysqli_query(dbcon(), "select * from notification order by notification.date_of_notification DESC")or die(mysqli_error());
					                    ...
					                    $query_yes_read = mysqli_query(dbcon(), "select * from notification_read where notification_id = '$id' and admin_id = '$session_id'")or die(mysqli_error());
					                    $read_row = mysqli_fetch_array($query_yes_read);				
					                    $yes = isset($read_row['admin_read']);
					   ?>
