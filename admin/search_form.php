	...
	<div class="modal-body">
		<form class="form-horizontal" method="post" action="advance_search.php">
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="stdev_location_name" class="" required>
						...
						<?php
						$class_query = mysqli_query(dbcon(), "select * from stlocation") or die(mysqli_error());
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="dev_serial" class="">
						<option value="">&larr; Select Device Serial &rarr;</option>
						<?php
						$serial_query = mysqli_query(dbcon(), "select * from stdevice") or die(mysqli_error());
