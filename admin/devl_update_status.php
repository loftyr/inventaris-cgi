									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										mysqli_query(dbcon(), "update stdevice set 
										            dev_id = '$dev_id',																		
													dev_status = '$dev_status'
													where id = '$get_id' ")or die(mysqli_error());
													
										mysqli_query(dbcon(), "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Update Status $dev_name to $dev_status ')")or die(mysqli_error());			
										?>
										<script>
