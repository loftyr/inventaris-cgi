		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									?>
									    ...
									    mysqli_query(dbcon(), "insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit device info $dev_name')")or die(mysqli_error());
										?>
										<script>										
