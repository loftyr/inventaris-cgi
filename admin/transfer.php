                          ...
                          <div class="empty">
	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
									...
									<?php
									$query = mysqli_query(dbcon(), "select * from stdevice 
									   ...
									   <div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="dev_id" readonly="readonly" required>
													...
													<?php
													$device_query = mysqli_query(dbcon(), "select * from device_name")or die(mysqli_error());
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Move TO</label>
				                            ...
				                            <option></option>
			                                 <?php $result =  mysqli_query(dbcon(), "select * from stlocation")or die(mysqli_error()); 
										...
										mysqli_query(dbcon(), "update location_details set
										            date_deployment = '$ora',
													stdev_id = '$stdev_id'													
													where id = '$get_id' ")or die(mysqli_error());
													
										mysqli_query(dbcon(), "insert into activity_log (date,username,action) values(NOW(),'$admin_username','transfer Device  $dev_name to location id $stdev_id')")or die(mysqli_error());			
										?>
										<script>
