							...
							<form class="form-horizontal" method="post">											
										...
										<div class="control-group">
		                                 <label class="control-label" for="inputEmail">Device Name</label>
			                                <div class="controls">
				                              <select name="dev_id" class="chzn-select" id="dev_id"  required/>
				                                 <option></option>
				                                 ...
				                                 <!-- //&nbspName&nbsp<?php echo $row['dev_name']; ?> -->
				                                 <?php } ?>
				                               </select>
		                                     </div>
	                                    </div>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" class="span8" name="dev_serial" id="dev_serial" placeholder="Device Serial Number" required>
											</div>
										</div>
