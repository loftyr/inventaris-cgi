     ...
     <body id="home">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysqli_query(dbcon(), "select * from stdevice LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id");
...
<!-----------------------------------Content------------------------------------>
<?php
		$device_query = mysqli_query(dbcon(), "select * from stdevice
		...
		<td><?php
			...
			<td><?php
			   $device_query1 = mysqli_query(dbcon(), "select * from stdevice ")or die(mysqli_error());
