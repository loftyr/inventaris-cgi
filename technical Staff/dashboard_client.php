            ...
            <div class="row-fluid">
				<?php include('client_sidebar.php'); ?>	
                   <div class="span9" id="content">
                      <div class="row-fluid">
					     <?php $query= mysqli_query(dbcon(), "select * from client where client_id = '$session_id'")or die(mysqli_error());
...
<div id="page-wrapper">
        <?php 
	     $stocks = mysqli_query(dbcon(), "select * from stdevice
		...
		<?php 
	     $new = mysqli_query(dbcon(), "select * from stdevice
...
<div id="page-wrapper">
           <div class="row-fluid">
		 <?php 
	     $damage = mysqli_query(dbcon(), "select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		...
		<?php 
	     $Repaired = mysqli_query(dbcon(), "select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
...
<div id="page-wrapper">
           <div class="row-fluid">
        <?php 
	     $dump = mysqli_query(dbcon(), "select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		...
		<?php 
	     $location = mysqli_query(dbcon(), "select * from stlocation")or die(mysqli_error());
