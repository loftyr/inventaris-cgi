                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										<?php
											$mission_query = mysqli_query(dbcon(), "select * from content where title  = 'mission' ")or die(mysqli_error());
											$mission_row = mysqli_fetch_array($mission_query);
											echo $mission_row['content'];
										?>
								<hr>
										<?php
											$vision_query = mysqli_query(dbcon(), "select * from content where title  = 'vision' ")or die(mysqli_error());
